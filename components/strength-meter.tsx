...
const defaultTheme: StrengthMeterTheme = {
  ...
  input:
    "pr-20 border-border focus:border-primary focus:ring-primary/20 bg-background text-foreground",
  meterContainer: "w-full h-2 rounded-full bg-muted flex gap-1 overflow-hidden",
  meterSegment:
    "h-full rounded-sm transition-all duration-300 ease-in-out flex-1",
